    ...
    messages = [
        {"role": "system", "content": _blue_language_system_prompt(project.language)},
        {
            ...
            "content": (
                ...
                + "SCORE calibration — you are a strict venture capital jury, NOT a supportive coach:\n"
                + "1: Random characters, gibberish, or completely empty content. No idea present whatsoever.\n"
                + "2: Incoherent text — cannot identify what problem is being solved or who benefits.\n"
                + "3: Idea exists but is a single vague sentence, no detail, no feasibility, no market insight.\n"
                + "4: Weak — has a topic but missing problem definition, business model, or realistic milestone.\n"
                + "5: Below average — has some structure but significant gaps; would not survive a pitch.\n"
                + "6: Average — clear problem, plausible solution, but weak differentiation or risky execution.\n"
                + "7: Good — solid problem/solution fit, realistic plan, some evidence of market awareness.\n"
                + "8: Strong — well-defined, differentiated, concrete milestone, manageable risks.\n"
                + "9-10: Exceptional — reserve for truly outstanding submissions only.\n"
                + "CRITICAL: If the project description is gibberish, random text, or makes no logical sense, SCORE MUST BE 1 or 2. "
                + "Do not invent merit that isn't there. Be honest and strict.\n\n"
